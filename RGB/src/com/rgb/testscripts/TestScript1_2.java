...
public class TestScript1_2
{
	...
	public static void main(String[] args) throws InterruptedException
	{
		...
		try
		{
			...
			System.out.println("bg Color on Red Hover--"+bodyColorR);
			...
			Assert.assertEquals("Fail to Assert Background", "rgb(0, 255, 0) none repeat scroll 0% 0% / auto padding-box border-box", bodyColorG);

			Assert.assertEquals("Fail to Assert Green on Hover", "rgb(0, 0, 0)", val3);
